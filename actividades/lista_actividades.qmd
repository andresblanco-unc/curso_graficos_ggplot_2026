...
Realice gráficos de cajas para representar los resultados de la actividad 3.a.2
...
Represente los dos modelos calculados en la actividad 3.a.2 en un solo gráfico de barras aplicando una división del panel gráfico por temporada.
...
Agrupe los gráficos que realizó en la actividad 4.b. combinados de la siguiente manera:

- En una fila de todo el ancho de la figura, el modelo de regresión lel peso con la longitud de peces (actividad 2.c).

- En una segunda fila un gráfico de barras del modelo para invierno y un Boxplot para verano (actividades 3.b y 3.c).
